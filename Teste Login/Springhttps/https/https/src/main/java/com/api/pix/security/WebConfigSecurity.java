package com.api.pix.security;

import com.api.pix.service.ImplementacaoUserDetailsService;
...
public class WebConfigSecurity extends WebSecurityConfigurerAdapter implements HttpSessionListener {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse())
				...
				.antMatchers("/index","/callbackadress/**","/resources/**","/static/**","/templates/**","classpath:/static/**","classpath:/resources/**","classpath:/templates/**").permitAll()
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers(HttpMethod.GET, "/salvarusuario")
				//.antMatchers(HttpMethod.POST, "/salvarAcesso")
				//.antMatchers(HttpMethod.POST, "/deleteAcesso","/salvarAcesso")
		;
	}
}
